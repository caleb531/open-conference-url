...
def test_before_window(out, event_dicts):
    ...
    case.assertEqual(feedback["items"][1]["text"]["copy"], event_dicts[0]["location"])
    case.assertEqual(
...
def test_all_day_with_past(out, event_dicts):
    ...
    case.assertEqual(feedback["items"][1]["text"]["copy"], event_dicts[1]["location"])
    case.assertEqual(
...
def test_all_day_mixed(out, event_dicts):
    ...
    case.assertEqual(feedback["items"][0]["subtitle"], "8:00am")
    case.assertEqual(feedback["items"][0]["text"]["copy"], event_dicts[1]["location"])
    case.assertEqual(
...
def test_multiple_meetings_at_once(out, event_dicts):
    ...
    case.assertEqual(feedback["items"][1]["subtitle"], "8:15am")
    case.assertEqual(feedback["items"][1]["text"]["copy"], event_dicts[1]["location"])
    case.assertEqual(
        feedback["items"][1]["text"]["largetype"], event_dicts[1]["location"]
    )
...
def test_past_meetings_only(out, event_dicts):
    ...
    case.assertEqual(feedback["items"][2]["text"]["copy"], event_dicts[0]["location"])
    case.assertEqual(
...
def test_past_meetings_with_upcoming(out, event_dicts):
    ...
    case.assertEqual(feedback["items"][0]["subtitle"], "8:00am")
    case.assertEqual(feedback["items"][0]["text"]["copy"], event_dicts[2]["location"])
    case.assertEqual(
